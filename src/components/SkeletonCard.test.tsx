...
describe('SkeletonCard', () => {
  ...
  it('should render skeleton tags section with three tags', () => {
    const { container } = render(<SkeletonCard />);
  ...
  it('should have proper structure with content wrapper', () => {
    const { container } = render(<SkeletonCard />);
  ...
  it('should have footer section with author and tags', () => {
    const { container } = render(<SkeletonCard />);
  ...
  it('should have excerpt with short last line', () => {
    const { container } = render(<SkeletonCard />);
